...
public class AccountComponentServiceImpl implements AccountComponentService {
    ...
    public void createAccount(Account account) {
        ...
        account.getOrders().stream()
                .map(order -> OrderEntity.builder()
                        .withSsn(account.getSsn())
    ...
    public Account getAccount(String ssn) {
        ...
        //where ssn =  ssn
        Set<OrderEntity> orderEntities = orderDao.readAll(OrderEntity.templateBuilder()
                .withSsn(ssn)
                .build());

        return Account.builder().withSsn(ssn)
                .withAmount(accountEntity.getAmount())
                .withId(accountEntity.getId())
                .withOrders(orderEntities.stream()
    ...
    public BigDecimal getTotalAmountOnAccounts() {
        ...
        return BigDecimal.valueOf(entities.stream()
                .map(rr -> rr.getAmount()
                        .doubleValue())
